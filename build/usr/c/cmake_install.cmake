...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xcompilerx" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib/unix-v5" TYPE EXECUTABLE FILES "/workspaces/Unix-V5/build/usr/c/c0")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/unix-v5/c0" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/unix-v5/c0")
    if(CMAKE_INSTALL_DO_STRIP)
      execute_process(COMMAND "/usr/bin/strip" "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/unix-v5/c0")
    endif()
  endif()
endif()
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xcompilerx" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib/unix-v5" TYPE EXECUTABLE FILES "/workspaces/Unix-V5/build/usr/c/c1")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/unix-v5/c1" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/unix-v5/c1")
    if(CMAKE_INSTALL_DO_STRIP)
      execute_process(COMMAND "/usr/bin/strip" "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/unix-v5/c1")
    endif()
  endif()
endif()
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xcompilerx" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib/unix-v5" TYPE EXECUTABLE FILES "/workspaces/Unix-V5/build/usr/c/c2")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/unix-v5/c2" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/unix-v5/c2")
    if(CMAKE_INSTALL_DO_STRIP)
      execute_process(COMMAND "/usr/bin/strip" "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/unix-v5/c2")
    endif()
  endif()
endif()
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xcompilerx" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib/unix-v5" TYPE EXECUTABLE FILES "/workspaces/Unix-V5/build/usr/c/cvopt")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/unix-v5/cvopt" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/unix-v5/cvopt")
    if(CMAKE_INSTALL_DO_STRIP)
      execute_process(COMMAND "/usr/bin/strip" "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/unix-v5/cvopt")
    endif()
  endif()
endif()
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xcompilerx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE PROGRAM FILES "/workspaces/Unix-V5/build/cc")
endif()
